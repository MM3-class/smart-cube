  ...
  return (
    <div>
      ...
      <div className='w-full flex border-b-[36px] lg:border-b-2 overflow-x-scroll scroll-smooth no-scrollbar scroll relative lg:px-[54px] lg:py-[25px] pr-4'>
        ...
        <button className='sticky hidden lg:block 2xl:hidden border w-full h-full p-[16px] top-[50%] -translate-y-[25%] rounded-full right-0 bg-white shadow-md'>
          <ArrowRight color='#410DEB' />
        </button>
      </div>
